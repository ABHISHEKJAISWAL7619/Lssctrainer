...
//   // formData ab startAt bhi rakhega
...
//         setTrainerList(res.payload.data);
//         const options = res.payload.data.map((t) => t.name);
...
//         const options = res.payload.data.map((c) => c.title);
...
//     if (!formData.trainerId || !formData.courseId) {
//       alert("Please select valid Trainer and Course");
//       return;
//     }
//     if (!formData.startAt) {
...
//       centerId,
//       startAt: new Date(formData.startAt).toISOString(), // ISO format
//     };
...
//   return (
//     <div className="bg-white rounded-xl space-y-6 p-6 max-w-md mx-auto">
